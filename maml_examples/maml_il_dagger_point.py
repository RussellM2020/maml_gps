from sandbox.rocky.tf.algos.maml_dagger_il import MAMLIL
                            ...
                            for beta_steps, adam_steps in beta_adam_steps_list:
                                for bas in baselines:
                                    ...
                                    algo = MAMLIL(
                                        ...
                                        policy=policy,
                                        baseline=baseline,
                                        experts_dir='/home/russellm/abhishek_sandbox/maml_imitation/expert_policies/point',
                                        experts_loader='dummy_expert_loader',
                                    ...
                                    run_experiment_lite(
                                        ...
                                        seed=1,
                                        exp_prefix='pointMass_parallel_debug',
                                        exp_name='PR_IL_'
                                        +str(seed)
                                                 # +str(int(use_maml))
